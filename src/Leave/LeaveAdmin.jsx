...
export default function LeaveApprovalDashboard() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await axios.get(`https://eshwar-backend.azurewebsites.net/api/leaves/manager/${managerId}`, {
          method:'GET',
          headers:{
  ...
  const handleApprove = async (id) => {
    ...
    try {
      const token = localStorage.getItem('token')
      await axios.put(`https://eshwar-backend.azurewebsites.net/api/leaves/approve/${id}`, null,  {
  ...
  const handleReject = async () => {
    ...
    const token = localStorage.getItem('token')
      await axios.put(`https://eshwar-backend.azurewebsites.net/api/leaves/reject/${selectedLeaveId}/${rejectionReason}`, null,  {
