...
const MyTasks = props => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const response = await axios.get(`https://eshwar-backend.azurewebsites.net/apis/employees/tasksAssignedTo/${employeeId}`,{
          headers: {
  ...
  const taskTypeChange = async (event) => {
    ...
    if (event.target.value === "allTasks") {
      url = `https://eshwar-backend.azurewebsites.net/apis/employees/tasksAssignedTo/${employeeId}`;
    } else if (event.target.value === "overdueTasks") {
      url = `https://eshwar-backend.azurewebsites.net/apis/employees/OverdueTasks/PersonId/${employeeId}`;
    } else if (event.target.value === "pendingTasks") {
      url = `https://eshwar-backend.azurewebsites.net/apis/employees/PendingTasks/PersonId/${employeeId}`;
    } else if (event.target.value === "completedTasks") {
      url = `https://eshwar-backend.azurewebsites.net/apis/employees/CompletedTasks/PersonId/${employeeId}`;
    }
