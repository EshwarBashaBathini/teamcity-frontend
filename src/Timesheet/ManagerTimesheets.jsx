...
const ManagerTimesheets = () => {
  ...
  const fetchSubmissions = useCallback(async () => {
    ...
    try {
      let url = `https://eshwar-backend.azurewebsites.net/api/timesheets/list/manager/${employeeId}`;
        
      if (startDate && endDate) {
        url = `https://eshwar-backend.azurewebsites.net/api/timesheets/totalList/employeeId/${employeeId}/startDate/${startDate}/endDate/${endDate}`;
      }
  ...
  const handleApprove = async (id) => {
    ...
    try {
      await axios.put(`https://eshwar-backend.azurewebsites.net/api/timesheets/Approve/${id}/status/APPROVED`, null, {
        headers: {
  ...
  const handleReject = async () => {
    setLoading(true);
    try {
      await axios.put(`https://eshwar-backend.azurewebsites.net/api/timesheets/reject/${currentId}/status/REJECTED/comments/${comments}`, null, {
        headers: {
