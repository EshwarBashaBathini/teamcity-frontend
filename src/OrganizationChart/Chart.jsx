    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const [ employeesResponse] = await Promise.all([
          axios.get("https://eshwar-backend.azurewebsites.net/api/v1/employeeManager/employees",{
            method:'GET',
            headers : {
              'Authorization' : `Bearer ${token}`,
              'Content-Type': "application/json"
      ...
      try {
        ...
        const [ reportingResponse] = await Promise.all([
          axios.get(`https://eshwar-backend.azurewebsites.net/api/v1/employeeManager/reporting-to/${employeeId}`,{
            method:'GET',
            headers : {
              'Authorization' : `Bearer ${token}`,
              'Content-Type': "application/json"
